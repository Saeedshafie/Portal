...
public class FrameListStudent extends javax.swing.JFrame {

    Path StudentsPathTemp = Paths.get("src/Files", "Students.txt");
    String StudentsPath = String.valueOf(StudentsPathTemp);
    
    public FrameListStudent() {
        initComponents();
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        jTableListStudents.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
    ...
    private void initComponents() {
        ...
        jTableListStudents.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "نام و نام خانوادگی", "شماره دانشجویی", "رشته"
            }
        ));
        ...
        try {
         ...
         if(!file.IsEmpty()){
            ...
            for(int i = 0; i < CountLines; i++)
            {
               ...
               int startCourse = data.indexOf("course=") + 7;
               int endCourse = data.indexOf(";", startCourse);
               String course = data.substring(startCourse, endCourse);
               model.addRow(new Object[]{name, studentnumber, course});
            }
         }
         } catch (IOException ex) {
         Logger.getLogger(FrameListStudent.class.getName()).log(Level.SEVERE, null, ex);
         }         
    }    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameListStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameListStudent().setVisible(true);
            }
        });
    }
